...
//   images = [],
//   interval = 5000,       // время показа одного изображения
//   transition = 1500,     // длительность перехода (мс)
//   blur = 20,             // сила размытия (px)
//   scale = 1.05,          // эффект увеличения
//   overlay = null,        // контент поверх слайдера
...
//   return (
//     <div className={`bg-slider ${className}`} style={{ height }}>
//       {images.map((img, i) => (
//         <div
//           key={i}
